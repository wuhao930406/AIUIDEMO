/**
 * Created by kurosaki on 2018/10/30.
 */
...
export default class AiTransfer extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillUnmount() {
        this.recognizerEventEmitter = new NativeEventEmitter();
        this.synthesizerEventEmitter = new NativeEventEmitter();
    }
